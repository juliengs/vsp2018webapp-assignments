...
The presentation mode will be implemented using a modal window. You will use [PhotoGalleryLib](https://github.com/juliengs/vsp2018webapp-assignments/blob/master/PhotoGalleryLib.js) again for this assignment. The documentation and some examples of how to use this library can be found [here](https://github.com/juliengs/vsp2018webapp-assignments/blob/master/PhotoGalleryLib.md).
